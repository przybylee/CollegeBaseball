...
for(yr in 1872:2018){
  ...
  N <- length(lgs)
  model1 <- lm(SLG ~ playerID + LGYR, weights = PA, data = obs.yr)
...
LEplot <- LEplot+labs(title = "League Effects on SLG", x = "Year", y = "Difference from NL 2018 SLG")+ scale_x_continuous(breaks=seq(1870, 2020, 10))
